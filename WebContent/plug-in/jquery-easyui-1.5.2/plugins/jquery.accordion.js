...
(function ($) {
    ...
    $.fn.accordion = function (_53, _54) {
        ...
        return this.each(function () {
            ...
            if (_55) {
                ...
                $.data(this, "accordion", {
                    options: $.extend({}, $.fn.accordion.defaults, $.fn.accordion.parseOptions(this), _53),
    ...
    $.fn.accordion.parseOptions = function (_5d) {
        var t = $(_5d);
        return $.extend({}, $.parser.parseOptions(_5d, ["width", "height", "halign", {
            fit: "boolean",
            border: "boolean",
            animate: "boolean",
            multiple: "boolean",
