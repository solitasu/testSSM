...
(function ($) {
    ...
    function _21(_22) {
        ...
        _23.window.draggable({
            ...
            disabled: _23.options.draggable == false,
        ...
        _23.window.resizable({
            disabled: _23.options.resizable == false, onStartResize: function (e) {
                _24(e);
            }, onResize: function (e) {
                _25(e);
                return false;
        ...
        function _24(e) {
            ...
            _23.pmask.css({
                ...
                left: e.data.left,
                top: e.data.top,
                width: _23.window._outerWidth(),
                height: _23.window._outerHeight()
            });
            if (_23.proxy) {
                _23.proxy.remove();
            }
